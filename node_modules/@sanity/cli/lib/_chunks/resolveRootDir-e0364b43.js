...
var require$$2$2 = require('get-it/middleware');
...
var polyfilledEventSource = /*@__PURE__*/getDefaultExportFromCjs(nodeExports$1);
var name = "@sanity/client";
var version = "5.2.0";
const middleware = [require$$2$2.debug({
  verbose: true,
...
function defineHttpRequest(envMiddleware) {
  const request = require$$1.getIt([...envMiddleware, printWarnings, require$$2$2.jsonRequest(), require$$2$2.jsonResponse(), require$$2$2.progress(), httpError, require$$2$2.observable({
...
function isSanityV2StudioRoot(basePath) {
  try {
    const content = require$$0__default$4.default.readFileSync(path__default.default.join(basePath, "sanity.json"), "utf8");
...
function fileExists(filePath) {
  return require$$0__default$4.default.existsSync(filePath);
}
...
//# sourceMappingURL=resolveRootDir-e0364b43.js.map
