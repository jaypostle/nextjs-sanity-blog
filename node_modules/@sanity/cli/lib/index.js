...
var resolveRootDir = require('./_chunks/resolveRootDir-e0364b43.js');
var getCliConfig = require('./_chunks/getCliConfig-bf07f3b1.js');
...
function getCliClient() {
  ...
  if (projectId && dataset) {
    return resolveRootDir.createClient({
      projectId,
      dataset,
      apiVersion,
      useCdn,
